...
function makeGraphs(error, europeStatsWellbeing, countriesJson) {
    ...
    europeStatsWellbeing.forEach(function (d) {
        ...
        d.life_is_worthwhile = +d.life_is_worthwhile;
        d.life_is_worthwhile.agree = +d.life_is_worthwhile["agree"];
        ...
        d.close_to_neighbours = +d.close_to_neighbours;
        ...
        d.happiness_extremely_happy = +d.happiness["extremely_happy"];
